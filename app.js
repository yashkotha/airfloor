...
function redrawCharts(){ drawElevation(1); refreshActiveView(); renderFloorReport(); renderMet(); renderRobust(); }
...
function renderAll(){ renderAQ(); renderSources(); updateGates(); if(STATE.floors!=null){ recompute(); renderTier(); renderPeak(); redrawCharts(); } }
...
function applyLang(lang){
  ...
  positionGlider(); renderTier(); renderAQ(); renderSources(); redrawCharts();
}
